...
public class FeeController extends ToolController {
    ...
    @FXML
    private TableColumn<Map,String> buyColumn;  //学生信息表 院系列
    @FXML
    private TableColumn<Map,Double> moneyColumn; //学生信息表 出生日期列
    @FXML
    private TableColumn<Map,String> earntimeColumn; //学生信息表 邮箱列
    ...
    @FXML
    private TextField buyField; //学生信息  院系输入域

    @FXML
    private TextField moneyField;  //学生信息  出生日期选择域

    @FXML
    private DatePicker earntimePick;  //学生信息  出生日期选择域
    ...
    public void initialize() {
        ...
        buyColumn.setCellValueFactory(new MapValueFactory<>("buy"));
        moneyColumn.setCellValueFactory(new MapValueFactory<>("money"));
        earntimeColumn.setCellValueFactory(new MapValueFactory<>("earntime"));
        ...
        earntimePick.setConverter(new LocalDateStringConverter("yyyy-MM-dd"));
    }
    ...
    public void clearPanel(){
        ...
        buyField.setText("");
        moneyField.setText("");
        earntimePick.getEditor().setText("");
    }
    ...
    protected void changeStudentInfo() {
        ...
        buyField.setText(CommonMethod.getString(form, "buy"));
        moneyField.setText(CommonMethod.getString(form, "money"));
        earntimePick.getEditor().setText(CommonMethod.getString(form, "earntime"));
    ...
    @FXML
    protected void onshuaxinClick(){DataResponse res;
    ...
    protected void onSaveButtonClick() {
        ...
        form.put("buy",buyField.getText());
        form.put("money",moneyField.getText());
        form.put("earntime",earntimePick.getEditor().getText());
        DataRequest req = new DataRequest();
        req.add("feeId", feeId);
        req.add("form", form);
        DataResponse res = HttpRequestUtil.request("/api/fee/feeSave",req);
        if(res.getCode() == 0) {
