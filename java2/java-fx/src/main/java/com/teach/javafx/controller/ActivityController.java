...
public class ActivityController extends ToolController {
    ...
    @FXML
    private TableColumn<Map,String> activityNameColumn;//活动名称
    @FXML
    private TableColumn<Map,String> activityTypeColumn;//类型
    @FXML
    private TableColumn<Map,String> timeColumn;//志愿时长
    @FXML
    private TableColumn<Map,String> activityGradeColumn;//等级
    @FXML
    private TableColumn<Map,String> timeOfActivityColumn;//活动时间
